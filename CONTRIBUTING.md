...
[How Can I Contribute?](#how-can-i-contribute)
  * [On AI/LLM Contributions](#on-aillm-contributions)
    * [Policy](#policy)
    * [Reasoning](#reasoning)
  ...
  * [Tip ioquake3 developers](#tip-ioquake3-developers)
...
With either of these services it might take a while before someone responds to your question, if you can't wait for an answer on Discord or IRC, [use the forums](https://discourse.ioquake.org)
...
* **Check the latest version** The version in our installers is from 2009! Check if you can reproduce the problem [in the latest build of ioquake3](http://ioquake3.org/get-it/).
